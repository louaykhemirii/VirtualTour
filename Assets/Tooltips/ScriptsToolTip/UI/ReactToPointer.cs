...
namespace TwoPm.TooltipDemo
{
    ...
    public class ReactToPointer : MonoBehaviour
    {
        ...
        public string TooltipMessageTitle;
        ...
        void OnDisable() {
            ...
            Control.OnPointerTooltipUpdatedTitle("");
        }
        ...
        void Update() {
            ...
            if (_delayElapsed && focused && !_focusTriggered) {
                ...
                if (!string.IsNullOrEmpty(TooltipMessageTitle)) {
                    Control.OnPointerTooltipUpdatedTitle(TooltipMessageTitle);
                }
                if (!string.IsNullOrEmpty(TooltipMessageDesc))
                {
                    Control.OnPointerTooltipUpdatedDesc(TooltipMessageDesc);
                }
            ...
            if (_focused && !focused) {
                ...
                if (!string.IsNullOrEmpty(TooltipMessageDesc))
                {
                    Control.OnPointerTooltipUpdatedDesc("");
                }
