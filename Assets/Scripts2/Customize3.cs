...
public class Customize3 : MonoBehaviour
{
    ...
    int i = 0;
    string url = "https://virtuelodc-backend.herokuapp.com/onecharacter/61b31b93404bbbd30cb818e6";
    string str;
    ...
    void get(WWW www)
    {
        ...
        switch (vetement)
        {
            ...
            case "1":
                ...
                break;
            case "2":
                clothesmat3.material = clothesmaterials[7];
                clothes3.mesh = clothesmeshes[7];
                break;
            case "3":
            ...
            case "V2":
                ...
                break;
            case "V3":
                clothesmat3.material = clothesmaterials[6];
                clothes3.mesh = clothesmeshes[6];
                break;
            case "V4":
                clothesmat3.material = clothesmaterials[4];
                clothes3.mesh = clothesmeshes[4];
        ...
        switch (accessoire)
        {
            ...
            case "ACC9":
                ...
                accmat3.material = accmats[8]; hairstyle2.mesh = meshes[4];
                break;
            case "ACC10":
            ...
            case "ACC11":
                ...
                accmat3.material = accmats[7]; hairstyle2.mesh = meshes[4];
                break;
            case "ACC12":
                acc3.mesh = accmeshs[0];
                accmat3.material = accmats[0]; hairstyle2.mesh = meshes[4];
                break;
            default:
                acc3.mesh = accmeshs[8];
